...
public class IsoscelesTriangle implements IShape {
	private int xMin;
	private int yMin;
	private int width;
	private int height;
	...
	public IsoscelesTriangle(ShapeColor primaryColor, ShapeColor secondaryColor, ShapeShadingType shade, int xMin, int yMin, int width, int height) {
